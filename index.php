...
<head>
    ...
    <style>
        * {
        ...
        .badge-urgente { background-color: #e74c3c; }
        .badge-ingreso { background-color: #d35400; }
        .badge-prioritario { background-color: #f39c12; }
        .badge-normal { background-color: #3498db; }
        .badge-pendiente { background-color: #f39c12; }
        .badge-autorizado { background-color: #27ae60; }
        .badge-rechazado { background-color: #e74c3c; }
    ...
    <script>
        ...
        function ajaxRequest(data, successCallback, errorCallback) {
            ...
            .catch(error => {
                ...
                if (errorCallback) errorCallback({message: 'Error de conexión'});
        ...
        window.TurnosModule = {
            ...
            crearTurno: function(datos, callback) {
                ajaxRequest(Object.assign({ajax_action: 'crear_turno'}, datos), callback);
            },
